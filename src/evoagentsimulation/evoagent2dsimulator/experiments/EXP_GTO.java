...
public class EXP_GTO extends SimulationEnvironment {
	...
	public void initialisation() 
	{
		...
		//Reward functions
		rewardFunctions.add(new RW_SensorOverThreshold(getBot(), 15, getBot().sensors.get("SENSOBJ"), 0.5)); //15
		rewardFunctions.add(new RW_ClosingOnTarget(getBot(), 0.08, to)); //0.08
		rewardFunctions.add(new RW_ForwardMotion(getBot(), 0.002)); //0.002
		rewardFunctions.add(new RW_Speed(getBot(), 0.00005)); //0.00005
	}
